  ...
  <div class="fixed-header">  
        ...
        <div class="navbar-wrapper">
          <div class="container">
            ...
            <li><a class="active" href="../user/login.php" data-hover="Log In">Log In</a></li>
  ...
  <div class="login-box-body">
    ...
    <form action="" method="post">
      <div class="form-group has-feedback">
        <input type="text" class="form-control" placeholder="Username" name="accno" autocomplete="off" required>
      ...
      <div class="row">
        ...
        <div class="col-xs-12">
          ...
          <button type="submit" class="btn btn-primary btn-block btn-flat" name="submitButton" style="background-color: #00BDCA; border-color:#00BDCA ">Sign In</button>
        </div>
        <!-- /.col -->
      </div>
    </form>
    <br>
    Dont have an account? <a href="register.php" class="text-center" style="text-align: center;">Create new account</a>
