<?php
  $sql = "SELECT * FROM tbl_users u, withdraw_requests a, tbl_transaction ad WHERE u.id = a.user_id AND ad.user_id = u.id AND a.approval=0 AND ad.status='processing'";
  $result = dbQuery($sql);
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <?php
                  ...
                  extract($row);
                  if ( $status) {
                    $statusVal = 'Requesting Withdrawal';
                  }
                ?>
                <tr>
